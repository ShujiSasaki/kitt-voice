# R50 Priority 2 Final Design v4 Revision (+v4.1 polish)

**作成日時 (JST)**: 2026-06-07 10:40:00 (v4) → 12:55:00 (v4.1 polish)
**Verify Token**: `[V4-Revision-Verify: R50-PRIORITY2-FINAL-DESIGN-V4.1-REVISION]`
**Author**: Claude (実装担当)
**Trigger**: GPT指示 Section 111 (v4) + Section 115 (v4.1 polish) + Gemini Route B 再監査 Section 110 + Gemini Round 3承認 Section 114

---

## v4.1 polish 追加 (Gemini Round 3任意推奨反映)

### A. Spot Fillsログ項目8追加
- 旧 (v4): 税務必須7項目のみ
- 新 (v4.1): 税務必須7項目 + **任意項目8 (証拠金口座への振替日時 - Spot→Perpsマージン振替ログ)**
- 用途: 監査・ガバナンス対応 (税務計算自体には影響しない)

### B. XRP却下表現マイルド化
- 旧 (v4): 「永久却下」
- 新 (v4.1): 「公式非対応のため物理経路から除外。 ※将来Hyperliquidが公式対応した場合のみ再検証対象」
- 理由: 今後の仕様変更可能性への余白を残す
...
`[V4-Revision-Verify: R50-PRIORITY2-FINAL-DESIGN-V4.1-REVISION]`
`[NextActor: GPT]`

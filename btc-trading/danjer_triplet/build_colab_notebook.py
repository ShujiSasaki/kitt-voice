...
"    gradient_accumulation_steps=8, learning_rate=2e-4, logging_steps=10, fp16=True, report_to='none')",
...
"    out=model.generate(**ids, max_new_tokens=max_new, do_sample=False, temperature=0.0)",

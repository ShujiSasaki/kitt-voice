...
重要: 緑色アイコン●=ピックアップ先(店舗)、赤色アイコン●=配達先(顧客)。store_nameは必ず緑アイコンの店舗名を使う。赤アイコンは顧客名なのでstore_nameに入れない。
summaryは「店舗名 ドロップ先町名 件数」。町名は市と区を省略して町名だけ。ピック・ドロップの順序はorder(P=ピック,D=ドロップ)に記載。
{"type":"accepted","summary":"ガスト天神サザン通り店 天神 1件","structured_data":{"store_name":"ガスト 天神サザン通り店","dropoff_area":"天神","delivery_count":1,"order":"PD"},"ai_note":"詳細メモ"}
複数件の配達(ダブル)の場合:
{"type":"accepted","summary":"マクドナルド赤坂店 赤坂/住吉 2件","structured_data":{"store_name":"マクドナルド赤坂店","dropoff_area":"赤坂/住吉","delivery_count":2,"order":"PPDD"},"ai_note":"詳細メモ"}
追いオファー(配達中に追加オファーを受諾)の場合、画面の先頭が赤アイコン(配達先)になることがある。その場合も緑アイコンの店舗名をstore_nameに使う:
{"type":"accepted","summary":"鮨よし田天神 春吉/天神 2件","structured_data":{"store_name":"鮨 よし田 天神","dropoff_area":"春吉/天神","delivery_count":2,"order":"DPPD"},"ai_note":"追いオファー"}

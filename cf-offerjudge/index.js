...
配達完了画面の場合(summaryは「配達 件数 金額 時間 距離 店舗名 ドロップ先の町名」の順。「配達完了」ではなく「配達」。町名は最後の市区以降だけ。1件なら「1件」、ダブルなら「2件」):
{"type":"result","summary":"配達 1件 ¥576 31分 3.64km 大衆焼肉港のたまや 警固","structured_data":{"store_name":"大衆焼肉 港のたまや","delivery_fee":"576","distance":"3.64 km","duration":"31分49秒","dropoff_address":"警固1丁目","delivery_date":"2026年3月24日","delivery_time":"午後6時51分"},"ai_note":"詳細メモ"}

...
配達完了画面の場合(summaryは「店舗名 ドロップ先町名 件数 金額 時間 距離」の順。町名は市区より後だけ。1件なら「1件」、ダブルなら「2件」):
{"type":"result","summary":"大衆焼肉港のたまや 警固 1件 ¥576 31分 3.64km","structured_data":{"store_name":"大衆焼肉 港のたまや","delivery_fee":"576","distance":"3.64 km","duration":"31分49秒","dropoff_address":"警固1丁目","delivery_date":"2026年3月24日","delivery_time":"午後6時51分"},"ai_note":"詳細メモ"}
...
注文詳細の場合(summaryは「店舗名 ドロップ先町名 件数 金額 時間 距離」の順):
{"type":"order_detail","summary":"鮨よし田天神 天神 1件 ¥462 15分 3.07km","structured_data":{"store_name":"鮨 よし田 天神","delivery_fee":"462","distance":"3.07 km","duration":"15分57秒","dropoff_area":"天神"},"ai_note":"詳細メモ"}
